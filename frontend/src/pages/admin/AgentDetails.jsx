...
import { useAgentDetailsQuery, useBlockAndUnblockMutation } from "@/redux/services/AdminApi";
  ...
  return (
    <div className="p-6 bg-white min-h-screen text-black font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-black text-white p-6 rounded-xl shadow-md mb-8">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-semibold">{agentData?.name || "Unknown Agent"}</h2>
              <p className="text-sm text-gray-300">{agentData?.email || "No email"}</p>
        ...
        {/* Properties */}
        <div>
          <h3 className="text-xl font-semibold mb-4">Listed Properties ({properties.length})</h3>
                ...
                >
                  ...
                  <div className="p-4 bg-gray-100 border-t border-black">
                    ...
                    <p className="text-xs text-gray-600 mt-2">
                      Views: {property.views} | Updated: {formatDate(property.updatedAt)}
                    </p>
                  </div>
                </div>
              ))
