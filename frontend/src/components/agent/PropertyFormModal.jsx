...
//   return (
//     <div className="fixed inset-0 backdrop-blur-sm flex items-center justify-center z-50 overflow-y-auto py-4">
...
const PropertyFormModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 overflow-y-auto py-6">
      <div className="bg-white rounded-2xl p-8 w-full max-w-4xl mx-4 max-h-[95vh] overflow-y-auto shadow-2xl">
        <div className="flex items-center justify-between mb-6 sticky top-0 bg-white py-4 border-b border-gray-200">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={formData.price}
                    onChange={handleInputChange}
                    className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
                    placeholder="450,000"
                    required
                  />
                </div>
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 bg-gray-50">
              ...
              <label 
                htmlFor="photos" 
                className={`cursor-pointer flex flex-col items-center justify-center transition-colors ${images.length >= 5 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100'} rounded-lg p-4`}
              >
                <div className="text-gray-600 text-center">
                  <Plus className="w-10 h-10 mx-auto mb-3 text-indigo-500" />
                  <span className="text-base font-medium">
                    {images.length > 0 
                      ? `Add more images (${5 - images.length} remaining)`
                      : 'Click to upload images'}
                  </span>
                  <p className="text-sm text-gray-400 mt-2">JPG, PNG, or WEBP (max 10MB each)</p>
                </div>
              </label>
          ...
          <div className="pt-6 border-t border-gray-200">
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-indigo-600 text-white py-3.5 px-6 rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center text-base font-medium"
            >
              {isLoading ? (
                <>
